...
/*   Updated: 2022/12/17 06:21:54 by minjungk         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	mapinfo(struct s_fdf *fdf)
{
	...
	mlx_string_put(fdf->mlx, fdf->win, 100, 50, FOREGROUND2, str);
	free(str);
	mlx_string_put(fdf->mlx, fdf->win, 20, 70, FOREGROUND0, "height : ");
	str = ft_itoa(fdf->map->height);
	mlx_string_put(fdf->mlx, fdf->win, 100, 70, FOREGROUND2, str);
	free(str);
}
